...
void setup() {
    ...
    if (client.isConnected()) {
        ...
        uint16_t messageid;
        client.publish("datatellit/outTopic", "hello world QOS1", MQTT::QOS1, &messageid);
        Serial.println(messageid);

        client.publish("datatellit/outTopic", "hello world QOS2", MQTT::QOS2, &messageid);
        Serial.println(messageid);

        // save QoS2 message id.
        qos2messageid = messageid;

        client.subscribe("datatellit/inTopic");
    }
}
